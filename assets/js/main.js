...
(() => {
  ...
  const translations = {
    pt: {
      ...
      nav: { doctor: 'O Médico', solutions: 'Soluções', results: 'Resultados', journey: 'Jornada', testimonials: 'Depoimentos', contact: 'Contato' },
    ...
    es: {
      ...
      nav: { doctor: 'El Médico', solutions: 'Soluciones', results: 'Resultados', journey: 'Proceso', testimonials: 'Testimonios', contact: 'Contacto' },
    ...
    en: {
      ...
      nav: { doctor: 'The Doctor', solutions: 'Solutions', results: 'Results', journey: 'Journey', testimonials: 'Testimonials', contact: 'Contact' },
